 ...
 * Recibe objetos de tipo Punto como argumentos del constructor. Subtemas:
 * 2.1, 2.2, 2.3, 2.4, 2.5.
 */
public class Distancia {
// Subtema 2.1 — Atributos privados

    private Punto puntoA = new Punto("",0,0); // Objeto como atributo (composición)
    private Punto puntoB = new Punto("",0,0);
